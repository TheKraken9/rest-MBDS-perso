package org.tpmbds.restmbds.project.controller;
...
import org.tpmbds.restmbds.project.service.ProjectService;
...
public class ProjectController {
    ...
    @GetMapping
    public ResponseEntity<List<ProjectSummaryResponse>> all() {
        return ResponseEntity.ok(service.getAll());
    }

    @GetMapping("/{id}")
    public ResponseEntity<ProjectResponse> one(@PathVariable Long id) {
